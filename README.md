...
local Toggle = Tabs.Genaral:AddToggle("MyToggle", {Title = "AutoSell", Default = false })
 ...
 local Toggle = Tabs.Genaral:AddToggle("MyToggle", {Title = "AutoBuyBelt", Default = false })
 ...
 local Toggle = Tabs.General:AddToggle("MyToggle", {Title = "AutoUnlock All Island", Default = false })
